      ...
      <div className="tn-modal" style={{maxWidth:900}}>
        ...
        <div className="tn-modal__body">
          ...
          <div style={{display:activeTab==="datos"?"":"none"}}>
            ...
            <div className="tn-form-section">
              <p className="tn-form-section__title"><span className="tn-step-badge">2</span> Fechas clave</p>
              <div className="tn-form-grid tn-form-grid--3">
            ...
            <div className="tn-form-section">
              <p className="tn-form-section__title"><span className="tn-step-badge">3</span> Estado y seguimiento</p>
              <div className="tn-form-grid tn-form-grid--3">
            ...
            <div className="tn-form-section">
              <p className="tn-form-section__title"><span className="tn-step-badge">4</span> Económico</p>
              <div className="tn-form-grid tn-form-grid--3">
            ...
            <div className="tn-form-section">
              <p className="tn-form-section__title"><span className="tn-step-badge">5</span> Orden de compra</p>
              <div className="tn-form-grid tn-form-grid--3">
            ...
            <div className="tn-form-section">
              <p className="tn-form-section__title"><span className="tn-step-badge">6</span> Observaciones</p>

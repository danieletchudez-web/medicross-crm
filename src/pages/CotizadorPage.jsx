      ...
      <div className="cot-page">
        ...
        <div className="cot-header">
          ...
          <div className="cot-header-actions">
            ...
            {docId && <>
              <div className="cot-toolbar__sep"/>
              <button className="cot-btn cot-btn--rev-tool"
                onClick={()=>{ if(window.confirm(`¿Estás a punto de generar una nueva versión del presupuesto #${quoteNum}.\n\nEl original se conserva intacto. ¿Confirmás?`)) createRevision(docId); }}
